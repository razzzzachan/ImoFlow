...
> Gerado em 2026-05-31T12:51:57.178Z para o snapshot local 2026-05-31.

Status geral: degraded
Janela: ultimos 7 dias

## Resumo
- Backend: 127 lp_view, 103 auth_view, 20 proof_section_view, 14 cta_click, 6 signup_started, 6 signup_completed nos ultimos 7 dias.
- Google Ads: 5 campanha(s) no filtro Imovex, 97 clique(s) e 7 conversao(oes) em 7 dias.
- Google Ads: termos suspeitos ainda visiveis: sisdea.
- GA4: 187 sessions, 114 engagedSessions e engagementRate 61%.
...
## Backend
- total de touchpoints: 565
- funil curto: cta_click=14, signup_started=6, signup_completed=6

## Google Ads
- 23849461361 | Imovex | Search | Imobiliaria | CRM WhatsApp | status=PAUSED | 7d clicks=88 | 7d conversions=7 | 7d cost=R$ 707.22
- 23853971002 | Imovex | Search | Corretor Solo | CRM Carteira | status=PAUSED | 7d clicks=0 | 7d conversions=0 | 7d cost=R$ 0.00
- 23873069498 | Imovex | Search | Imobiliaria | Bot WhatsApp | status=PAUSED | 7d clicks=9 | 7d conversions=0 | 7d cost=R$ 68.53
...
- engagedSessions: 114
- engagementRate: 61%
- eventos lidos: page_view=757, lp_view=116, cta_click=17, proof_section_view=16, signup_started=10, auth_form_started=9, auth_google_started=9, proof_tour_step_viewed=9, account_completion_view=7, proof_cta_click=7, proof_tour_opened=7, signup_completed=7, account_completion_started=6, account_completion_completed=5, auth_company_deferred=4, trial_crm_first_activated=2, proof_tour_closed=1
...
- siteId: 6712783
- correlacao automatica: 4 sessoes, 2 touchpoints e 7 conversoes com metadados Hotjar nos itens recentes
