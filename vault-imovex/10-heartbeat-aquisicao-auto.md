...
> Gerado em 2026-06-12T14:20:01.576Z para o snapshot local 2026-06-12.

Status geral: degraded
Janela: ultimos 7 dias

## Resumo
- Backend: 58 lp_view, 11 auth_view, 1 proof_section_view, 2 cta_click, 1 signup_started, 1 signup_completed nos ultimos 7 dias.
- Google Ads: 5 campanha(s) no filtro Imovex, 0 clique(s) e 0 conversao(oes) em 7 dias.
- GA4: 35 sessions, 13 engagedSessions e engagementRate 37%.
...
## Backend
- total de touchpoints: 130
- funil curto: cta_click=2, signup_started=1, signup_completed=1
...
- engagedSessions: 13
- engagementRate: 37%
- eventos lidos: page_view=94, lp_view=19, auth_form_started=3, account_completion_completed=1, account_completion_started=1, account_completion_view=1, auth_company_deferred=1, auth_google_started=1, cta_click=1, proof_section_view=1, signup_completed=1, signup_started=1
...
- siteId: 6712783
- correlacao automatica: 1 sessoes, 0 touchpoints e 3 conversoes com metadados Hotjar nos itens recentes
