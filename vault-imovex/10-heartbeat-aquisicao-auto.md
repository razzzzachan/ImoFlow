...
> Gerado em 2026-06-17T14:30:30.018Z para o snapshot local 2026-06-17.

Status geral: degraded
Janela: ultimos 7 dias

## Resumo
- Backend: 49 lp_view, 54 auth_view, 3 proof_section_view, 1 cta_click, 0 signup_started, 0 signup_completed nos ultimos 7 dias.
- Google Ads: 5 campanha(s) no filtro Imovex, 0 clique(s) e 0 conversao(oes) em 7 dias.
- GA4: 20 sessions, 4 engagedSessions e engagementRate 20%.
...
- engagedSessions: 4
- engagementRate: 20%
- eventos lidos: page_view=58, lp_view=20, proof_section_view=3, auth_form_started=1, auth_google_started=1
